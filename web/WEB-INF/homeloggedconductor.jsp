  ...
  <jsp:attribute name="content">
    ...
    <div class="covoit-container-fluid" style="margin-top: 1%; margin-bottom: 1%">
        <div id="page-top" class="d-flex justify-content-center align-items-center">
            ...
            <p class="page-top-title">Partagez votre prochain trajet</p>
        </div>
                ...
                <div class="covoit-home-content">
                    <div style="margin-top: 2%; margin-bottom: 2%">
                        <ul class="nav nav-pills">
                            <li class="nav-item">
                                <a class="nav-link" href="homeloggedpassenger">Passager</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" href="homeloggedconductor">Conducteur</a>
                            </li>
                        </ul>
                    </div>
                    <div>
